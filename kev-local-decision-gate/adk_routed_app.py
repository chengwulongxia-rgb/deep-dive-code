...
async def run_turn(*, kev_url: str, ticket: str, amount: int) -> None:
...
def main() -> None:
    ...
    asyncio.run(run_turn(kev_url=args.kev_url, ticket=args.ticket, amount=args.amount))
